...
registerBoxParts('longsword', [
  ...
  { size: [0.1, 0.22, 3.15], position: [0, 0.12, -1.25], color: 0xb8c0cc, metal: 0.85, rough: 0.22 },
]);
...
registerBoxParts('longsword_upgraded', [
  ...
  { size: [0.1, 0.22, 3.15], position: [0, 0.12, -1.25], color: 0xffd700, metal: 0.85, rough: 0.15, emissive: 0xffd700, emissiveIntensity: 0.3 },
]);
