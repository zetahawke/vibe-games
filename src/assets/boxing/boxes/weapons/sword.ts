...
registerBoxParts('shield', [
  { size: [0.85, 1.05, 0.1], position: [0, -0.2, 0.06], color: 0x4a5a8a, metal: 0.35, rough: 0.55 },
  { size: [0.24, 0.24, 0.12], position: [0, -0.12, 0.14], color: 0xc9a227, metal: 0.6, rough: 0.4 },
]);

registerBoxParts('shield_upgraded', [
  { size: [0.85, 1.05, 0.1], position: [0, -0.2, 0.06], color: 0xd4a017, metal: 0.75, rough: 0.25, emissive: 0xd4a017, emissiveIntensity: 0.18 },
  { size: [0.24, 0.24, 0.12], position: [0, -0.12, 0.14], color: 0xffd700, metal: 0.85, rough: 0.15, emissive: 0xffd700, emissiveIntensity: 0.3 },
]);
